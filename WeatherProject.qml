...
ApplicationWindow {
   ...
   // property int activeIndex: 1                  //TO INDICATE WHERE WE ARE VIEWING
    ...
    AnimatedImage {
        ...
        // source: "photos/clearnepal.jpg"S
                           ...
                           Repeater {
                               ...
                               Rectangle {
                                   ...
                                   Column {
                                       ...
                                       Text {
                                           id: tempText
                                           text: temperatures[model.index] !== undefined ? temperatures[model.index] + " Â°C" : ""
                                           font.pixelSize: 15
                                           // text: "23 C"
                                           color: "black"
                                           anchors.horizontalCenter: parent.horizontalCenter
...
Connections{
    target : weatherInfo
    function onWeatherTextChanged() {
            cityInfoText.text = weatherInfo.formattedWeatherText
        }
        function onAqiTextChanged() {
            cityInfoText.text += "\n\n" + weatherInfo.formattedAQIText
        }
        function onWeatherInfoUpdated(info) {
            cityInfoText.text = info
        }
    }
    ...
    Popup {
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                ...
                TextField {
                    ...
                    onAccepted: popupSearchButton.clicked()
                }
                Button {
                    id: popupSearchButton
                    text: "Search"
                    onClicked: {
                        weatherInfo.fetchResult(popupSearchField.text)
                    }
                }
            }
        ...
        onOpened: {
            var cityName = city.text
               ...
               weatherInfo.fetchResult(cityName)
        }
    }
